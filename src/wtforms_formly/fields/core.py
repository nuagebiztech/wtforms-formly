...
from wtforms_formly.validators import StopValidation, ValidationError
...
class Field:
    ...
    def __call__(self, **kwargs) -> dict | Markup:
        """
        Render this field as HTML, using keyword args as additional attributes.

        This delegates rendering to
        :meth:`meta.render_field <wtforms_formly.meta.DefaultMeta.render_field>`
...
class UnboundField:
    ...
    def __repr__(self):
        return f"<UnboundField({self.field_class.__name__}, {self.args!r}, {self.kwargs!r})>"
...
class Flags:
    ...
    def __repr__(self):
        ...
        return "<wtforms_formly.fields.Flags: {{{}}}>".format(", ".join(flags))
