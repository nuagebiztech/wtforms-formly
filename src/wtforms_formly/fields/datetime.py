...
from wtforms_formly.fields.core import Field
from wtforms_formly.utils import clean_datetime_format_for_strptime
...
class DateField(DateTimeField):
    """
    Same as :class:`~wtforms_formly.fields.DateTimeField`, except stores a
    :class:`datetime.date`.
    """
...
class MonthField(DateField):
    """
    Same as :class:`~wtforms_formly.fields.DateField`, except represents a month,
...
class WeekField(DateField):
    """
    Same as :class:`~wtforms_formly.fields.DateField`, except represents a week,
...
class DateTimeLocalField(DateTimeField):
    """
    Same as :class:`~wtforms_formly.fields.DateTimeField`, but represents an
